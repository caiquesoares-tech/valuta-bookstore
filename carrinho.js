/* ============================================================
   PRODUTO.JS - VERSÃO INTEGRAL E INTEGRADA (CSS PREMIUM)
   ============================================================ */

const livros = [
    { id: 1, titulo: "Crime e Castigo", autor: "Fiódor Dostoiévski", preco: "59,90", imagem: "crime-e-castigo.webp", bio: "Fiódor Dostoiévski é um dos maiores nomes da literatura russa.", foto: "autor-dostoievski.jpg" },
    { id: 2, titulo: "Os Irmãos Karamazov", autor: "Fiódor Dostoiévski", preco: "72,00", imagem: "os-irmaos-karamazov.jpg", bio: "Dostoiévski explorou profundamente a fé e a dúvida.", foto: "autor-dostoievski.jpg" },
    ...
    { id: 4, titulo: "Assim Falou Zaratustra", autor: "Friedrich Nietzsche", preco: "54,90", imagem: "assim-falou-zaratustra.jpg", bio: "Filósofo alemão cujas ideias mudaram o pensamento ocidental.", foto: "autor-nietzsche.jpg" },
    ...
    { id: 6, titulo: "Crepúsculo dos Ídolos", autor: "Friedrich Nietzsche", preco: "42,00", imagem: "crepusculo-dos-idolos.jpg", bio: "A filosofia de Nietzsche em aforismos.", foto: "autor-nietzsche.jpg" },
    { id: 8, titulo: "Odisseia", autor: "Homero", preco: "68,00", imagem: "odisseia.jpg", bio: "Fundação da literatura ocidental.", foto: "autor-homero.jpg" },
    { id: 9, titulo: "A Ilíada", autor: "Homero", preco: "70,00", imagem: "a-iliada.jpg", bio: "Narra a épica Guerra de Troia.", foto: "autor-homero.jpg" },
    { id: 10, titulo: "A Metamorfose", autor: "Franz Kafka", preco: "39,90", imagem: "a-metamorfose.jpg", bio: "Kafka retratou a alienação moderna.", foto: "autor-kafka.jpg" }
];
...
function renderizarCarrinho() {
    ...
    if (lista) {
        lista.innerHTML = carrinho.length === 0 ? "<p>Seu carrinho está vazio.</p>" : "";
        let soma = 0;
        
        carrinho.forEach((item, index) => {
            // USANDO CLASSES PREMIUM QUE SE CONECTAM AO CSS
            lista.innerHTML += `
